# @devtea2026/vel-aut-doloribus-reprehenderit
A tool for JSON parse and stringify by stream and web worker.

![language](https://img.shields.io/badge/language-JavaScript-orange.svg) 
[![npm version](http://img.shields.io/npm/v/@devtea2026/vel-aut-doloribus-reprehenderit.svg?style=flat)](https://npmjs.org/package/@devtea2026/vel-aut-doloribus-reprehenderit) 
[![license](https://img.shields.io/npm/l/@devtea2026/vel-aut-doloribus-reprehenderit.svg?style=flat)](https://npmjs.org/package/@devtea2026/vel-aut-doloribus-reprehenderit) 
[![gzip file size](http://img.badgesize.io/yuda-lyu/@devtea2026/vel-aut-doloribus-reprehenderit/master/dist/@devtea2026/vel-aut-doloribus-reprehenderit.umd.js.svg?compression=gzip)](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit)
[![npm download](https://img.shields.io/npm/dt/@devtea2026/vel-aut-doloribus-reprehenderit.svg)](https://npmjs.org/package/@devtea2026/vel-aut-doloribus-reprehenderit) 
[![npm download](https://img.shields.io/npm/dm/@devtea2026/vel-aut-doloribus-reprehenderit.svg)](https://npmjs.org/package/@devtea2026/vel-aut-doloribus-reprehenderit)
[![jsdelivr download](https://img.shields.io/jsdelivr/npm/hm/@devtea2026/vel-aut-doloribus-reprehenderit.svg)](https://www.jsdelivr.com/package/npm/@devtea2026/vel-aut-doloribus-reprehenderit)

## Documentation
To view documentation or get support, visit [docs](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/global.html).

## Installation
### Using npm(ES6 module):
> **Note:** @devtea2026/vel-aut-doloribus-reprehenderit is mainly dependent on `from2` and `jsonparse`.
```alias
npm i @devtea2026/vel-aut-doloribus-reprehenderit
```

#### Example for samll data:
> **Link:** [[dev source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/g-small.mjs)]
```alias
...
> **Link:** [[dev source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/g-large.mjs)]
```alias
...
#### Example for stream:
> **Link:** [[dev source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/g-stream.mjs)]
```alias
...
> **Note:** @devtea2026/vel-aut-doloribus-reprehenderit does not dependent on any package.

[Necessary] Add script for @devtea2026/vel-aut-doloribus-reprehenderit.
```alias

<!-- for basic -->
<script src="https://cdn.jsdelivr.net/npm/@devtea2026/vel-aut-doloribus-reprehenderit@1.0.21/dist/@devtea2026/vel-aut-doloribus-reprehenderit.umd.js"></script>

<!-- for web workers -->
<script src="https://cdn.jsdelivr.net/npm/@devtea2026/vel-aut-doloribus-reprehenderit@1.0.21/dist/@devtea2026/vel-aut-doloribus-reprehenderit.wk.umd.js"></script>

```

> **stringify and parse for small data:** [ex-small.html](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/examples/ex-small.html) [[source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/docs/examples/ex-small.html)]

> **stringifyByStream and parseByStream for small data:** [ex-small-stream.html](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/examples/ex-small-stream.html) [[source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/docs/examples/ex-small-stream.html)]

> **stringify and parse for large data:** [ex-large.html](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/examples/ex-large.html) [[source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/docs/examples/ex-large.html)]

> **createParseStream:** [ex-stream-createParseStream.html](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/examples/ex-stream-createParseStream.html) [[source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/docs/examples/ex-stream-createParseStream.html)] * ReadableStream does not support IE11.

> **createParseStream with filter:** [ex-stream-createParseStreamWithFilter.html](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/examples/ex-stream-createParseStreamWithFilter.html) [[source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/docs/examples/ex-stream-createParseStreamWithFilter.html)]

> **createStringifyStream:** [ex-stream-createStringifyStream.html](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/examples/ex-stream-createStringifyStream.html) [[source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/docs/examples/ex-stream-createStringifyStream.html)] * WritableStream does not support IE11 and Firefox.

> **stringify and parse for large data in web worker:** [ex-large-webworker.html](https://yuda-lyu.github.io/@devtea2026/vel-aut-doloribus-reprehenderit/examples/ex-large-webworker.html) [[source code](https://github.com/devtea2026/vel-aut-doloribus-reprehenderit/blob/master/docs/examples/ex-large-webworker.html)] * WebWorkers(from blob) does not support IE11.
```alias

console.log('WebWorkers(from blob) does not support IE11')

let json = window['@devtea2026/vel-aut-doloribus-reprehenderit']
console.log(json)
